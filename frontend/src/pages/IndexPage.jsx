...
import { BiLike } from "react-icons/bi";
  ...
  //! Like Functionality --------------------------------------------------------------
    ...
    return (
      <>
      <div classNam="mt-1 flex flex-col mx-10 sm:mx-0">
        <div className="hidden sm:block" >
          <div href="#" className="flex item-center inset-0">
            {/* <img  src="../src/assets/ems.jpg" alt="" className='mx-auto border rounded-xl ' />  */}
          </div>
        </div>

        <h1 className="text-3xl text-center my-10 mx-auto font-bold">Upcoming Events</h1>

        <div className="mx-10 my-5 grid gap-x-10 gap-y-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:mx-5 ">
          ...
          if (eventDate > currentDate || eventDate.toDateString() === currentDate.toDateString()){
            return (
              ...
              {event.image && (
                ...
                <img src="../src/assets/broken.jpg" alt="" className='rounded-tl-[0.75rem] rounded-tr-[0.75rem] rounded-br-[0] rounded-bl-[0] object-fill aspect-16:9'/> 
